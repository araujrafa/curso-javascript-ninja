...
(function() {
    ...
    */
    // ?
    var subtraction = calculator(1, 0);
    var division = calculator(2, 2);
    var mod = calculator(2, 0);
    /*
    ...
    chamada.
    */
    console.log( 'O resultado da subtração é:' + sum(function(x, y) {
        return x - y;
    }));
    // 

    console.log( 'O resultado da multiplicação é:' + sum(function(x, y) {
        return x * y;
    }));
    // ?

    console.log( 'O resultado da divisão é:' + sum(function(x, y) {
        return x / y;
    }));
    // ?

    console.log( 'O resto da divisão é:' + sum(function(x, y) {
        return x % y;
    }));
    // ?
})();